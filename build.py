...
def build_flutter_dmg(version, features):
    ...
    app_base = './build/macos/Build/Products/Release'
    app_target = f'{app_base}/ZenyDesk.app' if os.path.exists(f'{app_base}/ZenyDesk.app') else f'{app_base}/RustDesk.app'
    system2(f'cp -rf ../target/release/service {app_target}/Contents/MacOS/')
    if os.path.exists(f'{app_base}/ZenyDesk.app') and not os.path.exists(f'{app_base}/RustDesk.app'):
        system2(f'ln -sf ZenyDesk.app {app_base}/RustDesk.app')
    '''
    system2(
